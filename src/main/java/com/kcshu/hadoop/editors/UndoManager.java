...
public class UndoManager
{
    ...
    public void setMaxUndoLevel(int undoLevel)
    {
        ...
        if(isConnected()) opHistory.setLimit(undoContext, this.undoLevel);
    }
    ...
    public void connect(StyledText styledText)
    {
        if(!isConnected() && styledText != null)
        {
            ...
            if(undoContext == null) undoContext = new ObjectUndoContext(this);
    ...
    private class UndoableOperation extends AbstractOperation
    {
         ...
         * 
         * @see
         * org.eclipse.core.commands.operations.AbstractOperation#execute(org
